...
/**
	 ...
	 * requires columns_api
	 */
	require_once('uc_api.php');

	$t_filter = current_user_get_uc_filter();
...
<tr>
	<td class="form-title" colspan="<?php echo $col_count; ?>">
		...
		<?php
		    ...
		    $rows = filter_get_uc_rows( $f_page_number, $t_per_page, $t_page_count, $t_bug_count, null, null, null, true ); /**cecy*/
			# -- Viewing range info --
			...
			echo plugin_lang_get( 'viewing_use_cases' );
