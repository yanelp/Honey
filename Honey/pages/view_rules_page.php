...
if ( ( ALL_PROJECTS == helper_get_current_project() ) && ( 0 == $f_master_bug_id ) ) {
		print_header_redirect( 'login_select_proj_page.php?ref=plugin.php?page=Honey/view_rules_page.php' );
	}
...
if (($count != 0)||($count2!=0)) {
	...
	$t_page=$t_page."&id_rule=-1&p_search=0";
